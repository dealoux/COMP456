...
respond(Bad_answer,A,C,Rules) :- 
    \+ member(Bad_answer,[help, yes,no,why,how(_)]),
...
run :-
	write('Please provide a knowledge base for the system.'),
	read(Filename),
	consult(Filename).